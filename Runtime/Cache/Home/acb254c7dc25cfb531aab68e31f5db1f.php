...
<div class="menu">
    ...
    <div class="home-card home-top">
        ...
        <div class="home-card-con">
            <?php if(is_array($recommendBook)): foreach($recommendBook as $key=>$v): ?><div class="home-book-item flex border-b touch-a" data-bookId="<?php echo ($v["id"]); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($v["id"]); ?>">
    ...
    <div class="home-card home-boy" alt="男生必读">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_26484__=0;$__FOR_END_26484__=3;for($i=$__FOR_START_26484__;$i < $__FOR_END_26484__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($boyLikeReadBook[$i]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($boyLikeReadBook[$i]['id']); ?>">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_5277__=3;$__FOR_END_5277__=6;for($i=$__FOR_START_5277__;$i < $__FOR_END_5277__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($boyLikeReadBook[$i]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($boyLikeReadBook[$i]['id']); ?>">
                	<img src="<?php echo (IMG_URL); ?>dcbw.jpg" data-src="<?php echo ($boyLikeReadBook[$i]['book_img']); ?>" alt="<?php echo ($boyLikeReadBook[$i]['book_name']); ?>" class="img-border"/>
                	<i class="book-name"><?php echo ($boyLikeReadBook[$i]['book_name']); ?></i>
            	</div><?php } ?>
    ...
    <div class="home-card home-girl">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_19730__=0;$__FOR_END_19730__=3;for($i=$__FOR_START_19730__;$i < $__FOR_END_19730__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($girlLikeReadBook[$i]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($girlLikeReadBook[$i]['id']); ?>">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_31971__=3;$__FOR_END_31971__=6;for($i=$__FOR_START_31971__;$i < $__FOR_END_31971__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($girlLikeReadBook[$i]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($girlLikeReadBook[$i]['id']); ?>">
                	<img src="<?php echo (IMG_URL); ?>dcbw.jpg"  data-src="<?php echo ($girlLikeReadBook[$i]['book_img']); ?>" alt="<?php echo ($girlLikeReadBook[$i]['book_name']); ?>" class="img-border"/>
                	<i class="book-name"><?php echo ($girlLikeReadBook[$i]['book_name']); ?></i>
            	</div><?php } ?>
    ...
    <div class="home-card">
        <div class="home-card-title flex">
            ...
            <i class="flex--fluid">校园青春</i>
        			...
        			<div class="home-book-item flex border-b touch" data-bookId="<?php echo ($xiaoYuanOneBook[0]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($xiaoYuanOneBook[0]['id']); ?>">
                 ...
                 <?php if(is_array($xiaoYuanBooks)): foreach($xiaoYuanBooks as $key=>$v): ?><a class="home-row-line flex touch-a border-b" data-bookId="<?php echo ($v["id"]); ?>" href="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($v["id"]); ?>">
    ...
    <div class="home-card" alt="都市娱乐">
        <div class="home-card-title flex">
            ...
            <i class="flex--fluid">都市娱乐</i>
        			...
        			<div class="home-book-item flex border-b touch" data-bookId="<?php echo ($duShiOnebook[0]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($duShiOneBook[0]['id']); ?>">
        ...
        <?php if(is_array($duShiBooks)): foreach($duShiBooks as $key=>$v): ?><a class="home-row-line flex touch-a border-b" data-bookId="<?php echo ($v["id"]); ?>" href="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($v["id"]); ?>">
    ...
    <div class="home-card" alt="总裁酷男">
        <div class="home-card-title flex">
            ...
            <i class="flex--fluid">总裁酷男</i>
        			...
        			<div class="home-book-item flex border-b touch" data-bookId="<?php echo ($hmOneBook[0]['id']); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($hmOneBook[0]['id']); ?>">
        		...
        		<?php if(is_array($hmBooks)): foreach($hmBooks as $key=>$v): ?><a class="home-row-line flex touch-a border-b" data-bookId="<?php echo ($v["id"]); ?>" href="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($v["id"]); ?>">
    ...
    <div class="home-card" alt="完本经典">
        ...
        <div class="home-card-con flex">
        	<?php if(is_array($gdBooks)): foreach($gdBooks as $key=>$v): ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($v["id"]); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($v["id"]); ?>">
    ...
    <div class="home-card" alt="新书精选">
        ...
        <div class="home-card-con flex">
            <?php if(is_array($newBooks)): foreach($newBooks as $key=>$v): ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($v["id"]); ?>" data-url="/xs/index.php/Home/Book/detail.html?bookId=<?php echo ($v["id"]); ?>">
                	<img src="<?php echo (IMG_URL); ?>dcbw.jpg"  data-src="<?php echo ($v["book_img"]); ?>" alt="<?php echo ($v["book_name"]); ?>" class="img-border"/>
                	<i class="book-name"><?php echo ($v["book_name"]); ?></i>
            	</div><?php endforeach; endif; ?>
        </div>
