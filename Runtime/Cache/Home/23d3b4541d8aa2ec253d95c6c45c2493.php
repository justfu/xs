...
<div class="menu">
    ...
    <div class="home-card home-boy" alt="男生必读">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_1877514486__=0;$__FOR_END_1877514486__=3;for($i=$__FOR_START_1877514486__;$i < $__FOR_END_1877514486__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($boyLikeReadBook[$i]['id']); ?>" data-url="/Home/Book/detail.html?bookId=<?php echo ($boyLikeReadBook[$i]['id']); ?>">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_143549497__=3;$__FOR_END_143549497__=6;for($i=$__FOR_START_143549497__;$i < $__FOR_END_143549497__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($boyLikeReadBook[$i]['id']); ?>" data-url="/Home/Book/detail.html?bookId=<?php echo ($boyLikeReadBook[$i]['id']); ?>">
                	<img src="<?php echo (IMG_URL); ?>dcbw.jpg" data-src="<?php echo ($boyLikeReadBook[$i]['book_img']); ?>" alt="<?php echo ($boyLikeReadBook[$i]['book_name']); ?>" class="img-border"/>
                	<i class="book-name"><?php echo ($boyLikeReadBook[$i]['book_name']); ?></i>
            	</div><?php } ?>
    ...
    <div class="home-card home-girl">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_1315792278__=0;$__FOR_END_1315792278__=3;for($i=$__FOR_START_1315792278__;$i < $__FOR_END_1315792278__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($girlLikeReadBook[$i]['id']); ?>" data-url="/Home/Book/detail.html?bookId=<?php echo ($girlLikeReadBook[$i]['id']); ?>">
        ...
        <div class="home-card-con flex">
            <?php $__FOR_START_1110423__=3;$__FOR_END_1110423__=6;for($i=$__FOR_START_1110423__;$i < $__FOR_END_1110423__;$i+=1){ ?><div class="flex-fluid home-book-box home-book-box-sc touch" data-bookId="<?php echo ($girlLikeReadBook[$i]['id']); ?>" data-url="/Home/Book/detail.html?bookId=<?php echo ($girlLikeReadBook[$i]['id']); ?>">
                	<img src="<?php echo (IMG_URL); ?>dcbw.jpg"  data-src="<?php echo ($girlLikeReadBook[$i]['book_img']); ?>" alt="<?php echo ($girlLikeReadBook[$i]['book_name']); ?>" class="img-border"/>
                	<i class="book-name"><?php echo ($girlLikeReadBook[$i]['book_name']); ?></i>
            	</div><?php } ?>
...
<footer>
    ...
    <div id="sp_nickname" class="fl" style="display: none">
    	<a href="/h5/home"><span><?php $username=session('username');echo empty($username)?'登陆':$username; ?></span></a> |
